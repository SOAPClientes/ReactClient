  ...
  const fetchStudents = async () => {
    const soapEnvelope = `
      <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
        <soap:Body>
          <Estudiantes2 xmlns="http://tempuri.org/" />
        </soap:Body>
      </soap:Envelope>`;
    ...
    const config = {
      headers: {
        ...
        SOAPAction: 'http://tempuri.org/Estudiantes2',
      },
    };
    ...
    try {
      ...
      if (resultElements.length > 0) {
        ...
        console.error('Estudiantes2Result not found in the response.');
      }
    } catch (error) {
...
export default SoapStudentsListClient;
